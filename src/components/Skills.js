                    ...
                    <div className="section-style">
                        ...
                        <div className="skills">
                            ...
                            <p className="now-text2">
                                ...
                                Read the blog post <span><a href="https://hackernoon.com/turning-users-invisible-edge-machine-learning-in-privacy-first-location-detection-k1a34tj">here</a></span> (we write in symbiosis with Kimmo 😄).
                                
                            </p>
                            <p className="now-text2">
                                <span className="year"><a href="/posts"> Check my blog</a></span> 
                            </p>
                            <div className="section-item">
                                <h2 className="section-topic2">
                                    Coding skills
                            ...
                            <p className="now-text2">
                                ...
                                I have basic Python Skills. I can build Scrapy / Splash spiders and crawlers to automatically collect data and make them do work for me. I have also built data connector scripts and various data spinning/engineering scripts.
                            </p>
                            <p className="now-text2">
