            ...
            <div className="container is-max-desktop">
                <div className="section-style">
                    <div className="section-item">
                            ...
                            <p className='about2'>Currently working as a <span className='teamwork-emphasis'>Performance Marketing Manager at <span><a href="https://www.rentle.io">Rentle</a><FaRecycle size={12} style={{marginLeft:"3px", marginTop:"", color:"#1DA1F2"}}/></span></span>.</p>
