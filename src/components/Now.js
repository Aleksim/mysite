            ...
            <div className="container minus is-max-desktop">
                <div className="section-style">
                    <div className="section-item">
                            <p className='about2'>Currently working as a <span className='teamwork-emphasis'>Performance Marketing Manager at <span><a target="_blank" href="https://www.rentle.io">Rentle</a><FaRecycle size={12} style={{marginLeft:"3px", marginTop:"", color:"#1DA1F2"}}/></span></span>...and as a windsurfing coach at <a target='_blank' href='https://helsinkisailing.com/en/'>HSS!</a></p>
